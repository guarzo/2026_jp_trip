...
All transportation and accommodation details in one place.
...
<div class="logistics-card">
  <h3><span class="icon">✈️</span> Outbound Flight</h3>
...
<div class="logistics-card">
  <h3><span class="icon">✈️</span> Return Flight</h3>
...
<div class="logistics-card">
  <h3><span class="icon">🚄</span> Train Journeys</h3>
